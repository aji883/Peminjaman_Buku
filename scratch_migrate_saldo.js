...
async function migrate() {
    ...
    try {
        ...
        console.log('Connected to DB:', process.env.DB_NAME || 'perpustakaan_db');
        
        // 1. Add saldo column to user
        try {
            await connection.query("ALTER TABLE user ADD COLUMN saldo DECIMAL(12,2) DEFAULT 0.00 AFTER password");
        ...
        try {
            await connection.query("ALTER TABLE pengembalian ADD COLUMN denda_dibayar TINYINT(1) DEFAULT 0 AFTER denda");
        ...
        `;
        await connection.query(createTransaksiTable);
